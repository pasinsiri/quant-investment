...
class SECFundData():
    ...
    def get_fund_by_amc(self, amc_uid:str, is_active:bool = True, exclude_ui:bool = True):
        ...
        if exclude_ui:
            res_df = res_df[~(res_df['proj_name_th'].str.contains('ห้ามขายผู้ลงทุนรายย่อย'))].reset_index(drop = True)
        return res_df 
